...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 28 23:06:33 2022
...
def searchui():
    ...
    buttonOk = tkinter.Button(window, text='FuzzySearch', command=fuzzy)
    ...
    labelName.place(x=200, y=5, width=300, height=20)
    
    labelName = tkinter.Label(window, text='Input the related result numbers you want to return', justify=tkinter.RIGHT, width=80)
    
    labelName.place(x=200, y=30, width=315, height=20)
    
    labelName = tkinter.Label(window, text='Press search to do the fuzzy search, press cancel to empty the input.', justify=tkinter.RIGHT, width=80)
    
    labelName.place(x=10, y=100, width=430, height=20)
    
    labelName = tkinter.Label(window, text='Input the specific text you want to search, Make sure the low and upper case is exactly the same.', justify=tkinter.RIGHT, width=80)
