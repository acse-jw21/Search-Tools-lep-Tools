...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  6 21:31:53 2022
...
#Function to check if the mental and ligand can be found from the databse   
def checks(mental,ligand):
    '''Function to check if he mntal and ligand can be found from the databse 
...
def davies(mental,ligand):
    ''' Davies function to extract the metal and ligands from the database and do davies operation to caculate the logb. 
