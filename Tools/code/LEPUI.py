...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 28 19:36:47 2022
...
def isfloat(str):
    ...
    try:
        ...
        return False
def trydavies(mental,ligand):
      '''Function to check if the davies work properly.
    
    metal and ligand comes from user input.'''
      try:
          checks(mental,ligand)
          return True
      except Exception():
          return False
      
def checkpqo(mental, ligand1, ligand2,ph1,ph2,ph3,ion1,ion2,ion3):
...
def main(mental,ligand1,ligand2,ph1,ph2,ph3,ion1,ion2,ion3):
    '''Function to do the call of each functions, to run the system intergreted.
    
    metal and ligand comes from user input.'''
    
    boos = False
    if checks(mental,ligand1) and checks(mental,ligand2):
     davies(mental, ligand1)
     davies(mental,ligand2)
     pqi(mental, ligand1)
     pqi(mental, ligand2)
     if checkshell():
      if checkpqo(mental, ligand1, ligand2,ph1,ph2,ph3,ion1,ion2,ion3):     
       lepion(mental,ligand1, ligand2)
       boos = lepph(mental, ligand1, ligand2)
      else:
        print("Not support"+mental+ ligand1+ligand2)
        tkinter.messagebox.showinfo(title='end', message= "Not support"+mental+ ligand1+ligand2)
        return False
      return boos
     else:
                     ...
                     if ph1!=ph2 and ph2 !=ph3 and ph1!=ph3:
                         if ion1 != ion2 and ion2!=ion3 and ion1 != ion3:
                             if mental != "" and ligand1 != "" and ligand2 != "":
                                 ...
                                 tkinter.messagebox.showerror(title='end', message="Error, check the mental and ligand input")
                         else:
      ...
      if trydavies(mental,ligand1) and trydavies(mental,ligand2):
        if checks(mental,ligand1) and checks(mental,ligand2):
          if main(mental,ligand1,ligand2,ph1,ph2,ph3,ion1,ion2,ion3):
           tkinter.messagebox.showinfo(title='end', message='Done, find the lep')
          else:
              tkinter.messagebox.showinfo(title='end', message='Done, but dont find the lep')
          
        else:
          tkinter.messagebox.showerror(title='end', message="Error, can't find the mental or ligand, please check input")
